Feature: Blog parsing
  ...
  Scenario: jessiibrownie
    When I visit url https://jessiibrownie.wordpress.com/2016/01/29/a-day-in-agua-blanca/ in file jessiibrownie.pdf
  ...
  Scenario: bellamorous
    When I visit url http://bellamorous.blogspot.com/2016/02/life-college.html in file bellamorous.pdf
...
#    And I should not see Besos... Carli
  ...
  Scenario: shefinds
    When I visit url http://www.shefinds.com/2016/5-ways-to-make-the-most-of-the-money-talk-adultlife/ in file shefinds.pdf
  ...
  Scenario: thesmallthingsblog
    When I visit url http://www.thesmallthingsblog.com/2016/02/1-braid-2-ways-to-finish-the-style/ in file thesmallthingsblog.pdf
  ...
  Scenario: extrapetite
    When I visit url http://www.extrapetite.com/2016/01/snow-day.html?utm_source=feedburner&utm_medium=feed&utm_campaign=Feed%3A+ExtraPetite+%28Extra+Petite%29 in file extrapetite.pdf
  ...
  Scenario: thechrisellefactor
    When I visit url http://thechrisellefactor.com/2016/01/5-apps-to-be-more-productive-in-2016/ in file thechrisellefactor.pdf
  ...
  Scenario: thesmallthingsblog2
    When I visit url http://www.thesmallthingsblog.com/2016/01/the-coffee-bar/ in file thesmallthingsblog2.pdf
  ...
  Scenario: beautezine
    When I visit url http://www.beautezine.com/brighten-tired-eyes-clinique-pep-start/ in file beautezine.pdf
    Then I should see Don’t forget to
  ...
  Scenario: urbanette
    When I visit url http://urbanette.com/lose-those-winter-blues-and-blahs/ in file urbanette.pdf
